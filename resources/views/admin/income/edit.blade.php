                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="{{route('admin.incomes.update', ['income' => $income])}}" method="post">
                                    @method('PUT')
                                    @csrf
                                    {{-- {{dd($income)}} --}}
                                    <div x-data="{ showPayerComponent : false}" x-cloak class="row mx-4 w-75">
                                        <div class="form-group col-sm-12 my-2">
                                            ...
                                            <input class="form-control" type="date" name="payment_date"
                                                id="payment_date" value="{{$income->payment_date}}">
                                        </div>
                                        ...
                                        <div class="form-group col-sm-12 my-2">
                                            ...
                                            <select class="form-control" name="income_type_id" id="income_type_id">
                                                ...
                                                <option {{$income->income_type_id == $incomeType->id ? 'selected' :
                                                    ''}}
                                                    value="{{$incomeType->id}}">
                                                    {{$incomeType->name}}
                                                </option>
                                        ...
                                        <div class="form-group col-sm-12 my-2">
                                            ...
                                            <select class="form-control" name="payer_type" id="payer_type"
                                                onchange="initSelect()">
                                                {{-- @change="$el.value != '' ? showPayerComponent = true :
                                                showPayerComponent = false"> --}}
                                                <option value=""></option>
                                                @foreach ( $payerTypes as $payerType )
                                                <option {{$income->payer->payer_type_id == $payerType->id ? 'selected' :
                                                    ''}}
                                                    value="{{$payerType->id}}">
                                                    {{$payerType->name}}
                                                </option>
                                        ...
                                        <div class="form-group col-sm-12 my-2">
                                            {{-- <div x-show="showPayerComponent"> --}}
                                                ...
                                                <span type="button" class="text-primary fw-light" data-bs-toggle="modal"
                                                    data-bs-target="#add-payer-modal">
                                                    Add New
                                                </span>
                                            </div>
                                            ...
                                            <div class="form-group col-sm-12 my-2">
                                                ...
                                                <input class="form-control" value="{{$income->amount}}" type="number"
                                            ...
                                            <div class="form-group col-sm-12">
                                                ...
                                                <select class="form-control" required name="payment_method"
                                                    ...
                                                    <option {{$income->payment_method == $key ? 'selected' : ''}}
                                                        value="{{$key}}">
                                                        {{$value}}
                                                    </option>
                                                    @endforeach
                                            ...
                                            <div class="form-group col-sm-12 my-2">
                                                ...
                                                <input class="form-control" value="{{$income->remark}}" type="text"
                                    ...
                                    <div class="modal-body">
                                        <form action="{{route('admin.payers.store')}}" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" required name="payer_type_id"
                                                    id="payer_type_id">
