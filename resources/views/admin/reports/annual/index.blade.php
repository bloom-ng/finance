        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="flush-headingTwo">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    Payer Type Annual Summary
                </button>
            </h2>
            <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo"
                data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">
                    <form class="form" action="{{route('admin.reports.payer_type.annual')}}" method="get">
                        <select class="mb-2 form-control form-control" name="year" id="year">
                            @for ($i = 0; $i < 50; $i++) <option value="{{$year+$i}}">{{$year+$i}}</option>
                                @endfor
                        </select>
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="flush-headingThree">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    Income Type Annual Summary
                </button>
            </h2>
            <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree"
                data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">
                    <form action="{{route('admin.reports.income_type.annual')}}" method="get">
                        <select class="mb-2 form-control form-control" name="year" id="year">
                            @for ($i = 0; $i < 50; $i++) <option value="{{$year+$i}}">{{$year+$i}}</option>
                                @endfor
                        </select>
