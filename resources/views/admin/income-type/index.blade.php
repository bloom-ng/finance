...
<head>
    ...
    <title>Finance | Income Type</title>
                            ...
                            <div class="card bg-success text-white mb-4">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link"
                                        href="{{route('admin.income-types.create')}}">Click here</a>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-around">
                                                <a
                                                    href="{{route('admin.income-types.edit', ['incomeType' => $incomeType])}}"><button
                                                        type="button"
                                                        class="text-white btn btn-warning">Edit</button></a>
